<?php
/**
 * views/pagar/form_baixar.php
 *
 * Formulário para baixar uma conta à pagar
 *
...
<div class="botoes_opcao">
    ...
    <input type="button" id="botao_submit" value="baixar" />
</div>
<h1><?php echo $atividade; ?></h1>
<form action="<?php echo site_url(); ?>pagar/gravar" method="post" id="form_baixar" >
    <div class="limpa"></div>
    <input type="hidden" name="id_pagar" value="<?php echo (isset($conta->id)) ? $conta->id : '0'; ?>" />
    <table>
        <tr>
            <td><label for="descricao">Descrição</label></td>
            <td colspan="5"><input id="descricao" name="descricao" type="text" value="<?php echo $conta->descricao; ?>" readonly="readonly" /></td>
        </tr>
        <tr>
            <td><label for="valor">Valor</label></td>
            <td><input id="valor" name="valor" type="text" value="<?php echo $conta->valor; ?>" /></td>
        ...
        <tr>
            ...
            <td colspan="2"><input id="vencimento" name="vencimento" type="text" value="<?php echo date_to_brazil($conta->vencimento); ?>" /></td>
            <td><label for="pagamento">Pagamento</label></td>
            <td colspan="2"><input id="pagamento" name="pagamento" type="text" value="<?php echo date('d/m/Y'); ?>" /></td>
        </tr>
    </table>
</form>